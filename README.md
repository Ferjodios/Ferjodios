...
|------------|-------------|
| [**Dog Breed Detector with GRAD-Cam**]([[https://github.com/DavidY343/arquidatos](https://github.com/Ferjodios/Dog-Breed-Detector-with-GRAD-Cam)]) | 🐕 An AI model for dog breed classification using PyTorch, enhanced with Grad-CAM to visually interpret its decisions through heatmaps. |
